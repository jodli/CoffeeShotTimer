...
class UpdateBeanUseCaseTest {
    ...
    fun `execute should update bean successfully with valid parameters`() = runTest {
        ...
        val result = updateBeanUseCase.execute(
            beanId, updatedName, updatedRoastDate, updatedNotes, updatedActive, updatedGrinderSetting
        )
    ...
    fun `execute should trim whitespace from inputs`() = runTest {
        ...
        // When
        val result = updateBeanUseCase.execute(
            beanId, updatedName, updatedRoastDate, updatedNotes, true, updatedGrinderSetting
        )
    ...
    fun `execute should handle empty grinder setting`() = runTest {
        ...
        // When
        val result = updateBeanUseCase.execute(
            beanId, updatedName, updatedRoastDate, lastGrinderSetting = updatedGrinderSetting
        )
