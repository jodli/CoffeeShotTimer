...
class ValidationExtensionsTest {
    ...
    @Before
    fun setup() {
        mockStringProvider = mockk<ValidationStringProvider>()
        ...
        every { mockStringProvider.getMinimumWeightError(any(), any()) } returns "Weight too low"
        every { mockStringProvider.getMaximumWeightError(any(), any()) } returns "Weight too high"
